                ...
                <div class="modal-body">  
                    ...
                    <form id="update-asset" action="">
                        @csrf
                            ...
                            <input type="text" class="form-control" name="property_name" id="edit-property-name" readonly>

                            <label for="" class="mt-2">Person-in-charge of the Property</label>
                            <input type="text" class="form-control" name="person_in_charge" id="edit-person-incharge" readonly>

                            <div class="row">
                                <div class="col-md-6">
                                    <label for="" class="mt-2">Model Number</label>
                                    <input type="text" class="form-control" name="model_number" id="edit-model-number" readonly>
                                </div>
                                <div class="col-md-6">
                                    <label for="" class="mt-2">Serial Number</label>
                                    <input type="text" class="form-control" name="serial_number" id="edit-serial-number" readonly>
                                </div>
                            </div>
