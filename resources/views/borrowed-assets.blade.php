                                    ...
                                    @if($as->status == 1)
                                        <tr>
                                            ...
                                            <td class="text-center" model_number='{{ $as->model_number }}'>
                                                <p class="text-xs font-weight-bold mb-0">{{ $as->model_number }}</p>
                                            </td>
                                            <td class="text-center" serial_number='{{ $as->serial_number }}'>
                                                <p class="text-xs font-weight-bold mb-0">{{ $as->serial_number }}</p>
                                            </td>
                                            ...
                                            <td contactnumber='{{ $as->contact_number }}' hidden></td>
                            ...
                            @php $cnt = 1; @endphp
                                @foreach($asset as $as)
                                    ...
                                    <tr>
                                            ...
                                            <td person_in_charge='{{ $as->person_in_charge }}' hidden></td>
                                            <td contactnumber='{{ $as->contact_number }}' hidden></td>
                                            <td model_number='{{ $as->model_number }}' hidden></td>
                                            <td serial_number='{{ $as->serial_number }}' hidden></td>
                                            <td condition='{{ $as->asset_condition }}' hidden></td>
                                            <td remarks='{{ $as->remarks }}' hidden></td>
